...
import glob
import shutil
from services.supabase_client import save_session_to_supabase, get_string_id_from_uuid
...
def test_data_loading(session_id):
    ...
    try:
        ...
        from services.supabase_client import create_or_get_session_uuid, get_supabase_client
        session_uuid = create_or_get_session_uuid(session_id)
...
def save_zeitschritte_endpoint():
    ...
    try:
        ...
        from services.supabase_client import save_zeitschritte
...
def download_file(session_id, file_type, file_name):
    ...
    """
    try:
        from services.supabase_client import get_supabase_client, get_string_id_from_uuid
        supabase = get_supabase_client()
        if not supabase:
