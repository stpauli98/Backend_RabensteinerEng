...
# Temporarily disabled TensorFlow imports
...
def train_dense(train_x, train_y, val_x, val_y, MDL):
    ...
    logger.warning("TensorFlow models are temporarily disabled")
    return None

def train_dense_disabled(train_x, train_y, val_x, val_y, MDL):    
    """
...
def train_cnn_disabled(train_x, train_y, val_x, val_y, MDL):    
    """
...
def train_lstm_disabled(train_x, train_y, val_x, val_y, MDL):
    """
...
def train_ar_lstm_disabled(train_x, train_y, val_x, val_y, MDL):
    """
