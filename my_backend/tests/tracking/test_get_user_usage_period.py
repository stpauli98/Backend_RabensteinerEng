...
def test_get_user_usage_filters_by_anniversary_period():
    ...
    # second .eq is the period_start filter
    second_eq = table.select.return_value.eq.return_value.eq
    second_eq.assert_called_once()
    assert second_eq.call_args.args[1] == "2026-06-15"
